...
# read_csv is a pandas function that reads a csv file and retrieves the data in the form of a DataFrame
...
def Emojify_V2(input_shape, word_to_vec_map, word_to_index):
    ...
    # The returned output should be a single X state, not a batch of sequences.
